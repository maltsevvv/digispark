...
if (keydata==0xED120707) TrinketHidCombo.pressKey(0, KEYCODE_PAGE_UP);      TrinketHidCombo.pressKey(0, 0); // (Page up)
if (keydata==0xEF100707) TrinketHidCombo.pressKey(0, KEYCODE_PAGE_DOWN);    TrinketHidCombo.pressKey(0, 0); // (Page down)
if (keydata==0xD32C0707) TrinketHidCombo.pressKey(0, KEYCODE_F1);           TrinketHidCombo.pressKey(0, 0); // (Отображение)
if (keydata==0xA7580707) TrinketHidCombo.pressKey(0, KEYCODE_F2);           TrinketHidCombo.pressKey(0, 0); // (Сортировка)
if (keydata==0xE01F0707) TrinketHidCombo.pressKey(0, KEYCODE_F3);           TrinketHidCombo.pressKey(0, 0); // (Избранное)
if (keydata==0xE41B0707) TrinketHidCombo.pressKey(0, KEYCODE_F4);           TrinketHidCombo.pressKey(0, 0); // (Перемещать)
